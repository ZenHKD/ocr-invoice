...
Usage:
    python visualize_synthetic.py data/test_output/invoice_000000_29a4b303.json
    python visualize_synthetic.py data/test_output/  # Visualize all in directory
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python visualize_synthetic.py <json_file_or_directory> [output_dir]")
        print("\nExamples:")
        print("  python visualize_synthetic.py data/test_output/invoice_000000.json")
        print("  python visualize_synthetic.py data/test_output/ data/visualized/")
        sys.exit(1)
