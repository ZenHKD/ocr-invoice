...
Usage:
    ...
    # Custom generation
    python test.py --num 500 --scenario training_hard --output data/training

    # Validation set (cleaner images)
    python test.py --num 100 --scenario validation --output data/validation
"""
...
from synthetic_data import SyntheticInvoiceGenerator
...
Examples:
    ...
    python test.py --num 100 --scenario training_balanced

    # Generate difficult training data
    python test.py --num 500 --scenario training_hard --output data/hard

    # Generate clean validation data
    python test.py --num 50 --scenario validation --output data/val

    # Focus on edge cases for robustness testing
    python test.py --num 200 --scenario edge_cases_focus
